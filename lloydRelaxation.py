...
def voronoiPolynomials(points,boundingPolygon=Polygon.Polygon([ (0,0), (1,0),(1,1),(0,1) ]) ):
...
def lloydRelaxation(points, iterations):
    ...
    vpolys = voronoiPolynomials(points)
    return lloydRelaxation([ poly.center()  for poly in vpolys ] , iterations-1)
